...
export function ChatArea({
  ...
  return (
    <div className="flex-1 flex flex-col">
      <div className="h-16 bg-white p-4 shadow">
          ...
          <div className="flex -space-x-2">
            {selectedChat.memberIds
              ...
              .map((memberId) => (
                <div
                  key={memberId}
                  className="w-8 h-8 rounded-full bg-blue-500 text-white flex items-center justify-center text-sm font-medium ring-2 ring-white relative hover:z-10 hover:scale-110 transform transition-all cursor-default"
                  title={`${memberId}`}
                >
